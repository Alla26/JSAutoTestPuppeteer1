...
describe("Github page tests - second task", () => {
  test("The h1 header content'", async () => {
    await page.goto(
      "https://github.com/join?plan=business&ref_cta=Get%2520started%2520with%2520Team&ref_loc=team-page-hero&ref_page=%2Fteam"
    );
    const firstLink = await page.$("main div div div");
    await firstLink.click();
    await page.waitForSelector("h1");
    const title2 = await page.title();
